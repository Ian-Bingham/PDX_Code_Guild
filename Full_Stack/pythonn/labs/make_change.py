...
def make_change(dollar_amt):
    ...
    dollar_amt_in_pennies = dollar_amt * 100  # convert dollars to pennies
    ...
    # get the biggest coins first then work down
    while left_over != 0:
    ...
    print(f"${dollar_amt} dollars was converted into {num_quarters} quarters, "
          "{num_dimes} dimes, {num_nickels} nickels, {num_pennies} pennies.")

dollar_amt = round(float(input("Please enter the dollar amount that you would "
                               "like to convert to coins: $")), 2)
