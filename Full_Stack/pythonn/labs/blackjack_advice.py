...
def main():
    while True:
        ...
        while True:
            first_card = input("What's your first card (type done to quit)? ").upper()
            if first_card == 'DONE':
                print("Goodbye!")
                exit(0)
        ...
        while True:
            second_card = input("What's your second card (type done to quit)? ").upper()
            if second_card == 'DONE':
                print("Goodbye!")
                exit(0)
        ...
        while True:
            dealer_card = input("What is the dealer showing (type done to quit)? ").upper()
            if dealer_card == 'DONE':
                print("Goodbye!")
                exit(0)
        ...
        print("You have a {} {}".format(soft_or_hard, first_card_value + second_card_value))
        print("Dealer has {}".format(dealer_card_value))
